...
public class ClickTabbar extends BaseLinearLayout implements OnClickListener{
	
	private Context context ;
	private static final int DEFAULT_LAYOUT_ID = R.layout.app_click_tabbar_layout;
	...
	{
		addTab(tab,R.layout.index_centent_tabbar_tab_layout,R.id.iv_tab_img,R.id.tv_tab_text);
	}
